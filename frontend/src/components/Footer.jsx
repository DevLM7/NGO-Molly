...
const Footer = () => {
  ...
  return (
    <footer className="bg-surface shadow-inner mt-8">
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <Link to="/" className="text-xl font-header font-bold text-primary">
              NGO<span className="text-secondary">Connect</span>
            </Link>
            <p className="text-sm text-gray-600 mt-1">
              Connecting volunteers and NGOs for a better world
            </p>
          </div>
        ...
        <div className="border-t border-gray-200 mt-6 pt-6 text-center">
          <p className="text-sm text-gray-600">
            &copy; {year} NGOConnect. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
